            ...
            @forelse($values as $value)
              <tr>
                <td class="action-cell">
                  <svg class="action-expand" onclick="editValue({{ $value->id }})" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="cursor:pointer; vertical-align:middle;">
