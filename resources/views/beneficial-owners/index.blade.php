          ...
          @foreach($beneficialOwners as $bo)
            ...
            <tr class="{{ $isExpired ? 'expired-row' : '' }}" data-owner-code="{{ $bo->owner_code }}">
              ...
              <td class="action-cell">
                <svg class="action-expand" onclick="openBeneficialOwnerDetails({{ $bo->id }})" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="cursor:pointer; vertical-align:middle;">
    ...
    <div class="modal-content" style="max-width:900px; max-height:90vh; overflow-y:auto;" onclick="event.stopPropagation();">
      <div class="modal-header" style="display:flex; justify-content:space-between; align-items:center; padding:15px 20px; border-bottom:1px solid #ddd; background:#fff;">
        ...
        <div style="display:flex; gap:10px;">
          ...
          <button type="button" class="btn-cancel" onclick="closeBeneficialOwnerDetailModal()" style="background:#000; color:#fff; border:none; padding:8px 20px; border-radius:2px; cursor:pointer; font-size:13px;">Close</button>
        </div>
      </div>
      <div class="modal-body" style="padding:20px;">
