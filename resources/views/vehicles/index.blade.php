        ...
        <div id="vehicleFormPageContent" style="display:none;">
          <div style="background:#fff; border:1px solid #ddd; border-radius:4px; margin-bottom:15px; overflow:hidden;">
            <div
              ...
              <div class="client-page-actions">
                <button type="button" class="btn-delete" id="vehicleDeleteBtn"
                ...
                <button type="submit" form="vehiclePageForm" class="btn-save"
                  style="background:#f3742a; color:#fff; border:none; padding:6px 16px; border-radius:2px; cursor:pointer;">Save</button>
                <button type="button" class="btn" id="closeVehicleFormBtn" onclick="closeVehiclePageView()"
    ...
    <div class="modal-content">
      ...
      <form id="vehicleForm" method="POST" action="{{ route('vehicles.store') }}">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn-delete" id="vehicleDeleteBtn" style="display: none;"
            onclick="deleteVehicle()">Delete</button>
