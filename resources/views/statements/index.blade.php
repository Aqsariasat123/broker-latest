            ...
            <tbody>
              ...
              <tr>
                <td class="action-cell">
                  <img src="{{ asset('asset/arrow-expand.svg') }}" class="action-expand" onclick="openStatementDetails({{ $st->id }})" width="18" height="18" style="cursor:pointer; vertical-align:middle;" alt="Expand">
