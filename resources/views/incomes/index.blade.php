...
<div class="dashboard">
  ...
  <div class="clients-table-view" id="clientsTableView">
    <div class="container-table">
        ...
        <div class="table-responsive" id="tableResponsive">
          <table id="incomesTable">
            ...
            <tbody>
              ...
              <tr
                class="{{ $inc->hasExpired ?? false ? 'has-expired' : ($inc->hasExpiring ?? false ? 'has-expiring' : '') }}">
                <td
                  class="bell-cell {{ $inc->hasExpired ?? false ? 'expired' : ($inc->hasExpiring ?? false ? 'expiring' : '') }}">
                ...
                <td class="action-cell">
                  <img src="{{ asset('asset/arrow-expand.svg') }}" class="action-expand"
                    onclick="openIncomeDetails({{ $inc->id }})" width="18" height="18"
                ...
                <td data-column="amount_received">{{ $inc->amount_received ? number_format($inc->amount_received, 2) :
                  '-' }}</td>
      ...
      <div class="footer"
        style="background:#fff; border-top:1px solid #ddd; padding:10px 20px; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap;">
        <div class="footer-left">
          <a class="btn btn-export"
            href="{{ route('incomes.export', array_merge(request()->query(), ['page' => $incomes->currentPage()])) }}">Export</a>
        ...
        <div id="incomeFormPageContent" style="display:none;">
          <div style="background:#fff; border:1px solid #ddd; border-radius:4px; margin-bottom:15px; overflow:hidden;">
            <div
              ...
              <div class="client-page-actions">
                <button type="button" class="btn-delete" id="incomeDeleteBtn"
                  style="display:none; background:#dc3545; color:#fff; border:none; padding:6px 16px; border-radius:2px; cursor:pointer;"
                  onclick="deleteIncome()">Delete</button>
                <button type="submit" form="incomePageForm" class="btn-save"
                  style="background:#f3742a; color:#fff; border:none; padding:6px 16px; border-radius:2px; cursor:pointer;">Save</button>
                <button type="button" class="btn" id="closeIncomeFormBtn" onclick="closeIncomePageView()"
  ...
  <div class="modal" id="incomeModal">
    <div class="modal-content" style="max-width:800px; max-height:90vh; overflow-y:auto;">
      ...
      <form id="incomeForm" method="POST" action="{{ route('incomes.store') }}" enctype="multipart/form-data">
        ...
        <input type="file" name="document" id="documentFileInput" style="display:none;"
          accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
        <div class="modal-body" style="padding:20px;">
          <div class="form-row" style="display:flex; gap:15px; margin-bottom:15px;">
            <div class="form-group" style="flex:1;">
              <label for="statement_no"
                style="display:block; margin-bottom:5px; font-size:13px; font-weight:500;">Select Statement</label>
              <select class="form-control" name="statement_no" id="statement_no"
            ...
            <div class="form-group" style="flex:1;">
              <label for="date_rcvd" style="display:block; margin-bottom:5px; font-size:13px; font-weight:500;">Date
                Received</label>
            ...
            <div class="form-group" style="flex:1;">
              <label for="amount_received"
                style="display:block; margin-bottom:5px; font-size:13px; font-weight:500;">Amount Received</label>
          ...
          <div class="form-row" style="display:flex; gap:15px; margin-bottom:15px;">
            <div class="form-group" style="flex:1;">
              <label for="income_source_id"
                style="display:block; margin-bottom:5px; font-size:13px; font-weight:500;">Income Source</label>
          ...
          <div id="selectedDocumentPreview"
            ...
            <div style="display:flex; justify-content:space-between; align-items:center;">
              ...
              <button type="button" onclick="removeSelectedDocument()"
        ...
        <div class="modal-footer"
          ...
          <button type="button" class="btn-upload" onclick="openDocumentUploadModal()"
            style="background:#f3742a; color:#fff; border:none; padding:8px 20px; border-radius:2px; cursor:pointer; font-size:13px;">Upload
            Document</button>
          <button type="button" class="btn-delete" id="incomeDeleteBtnModal"
    ...
    <div class="modal-content" style="max-width:500px;">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input type="file" class="form-control" name="document" id="documentFile"
            accept=".pdf,.jpg,.jpeg,.png,.doc,.docx" onchange="handleDocumentFileSelect(event)">
