    ...
    public static function getConfig($module)
    {
        $configs = [
            ...
            'vehicles' => [
                ...
                'default_columns' => [
                    'regn_no','make','model','year','type','useage','engine_type', 'cc','engine_no','chassis_no',
                    'value','policy_id','notes','vehicle_id',
                    'from','to',
            ...
            //     'default_columns' => [
            //         'policy_code','client_name','insurer','grouping','basic_premium','rate',
            //         'amount_due','payment_status','amount_rcvd','date_rcvd','state_no',
            //         'mode_of_payment','variance','reason','date_due','cnid'
            //     ],
            //     'mandatory_columns' => ['policy_code', 'client_name', 'cnid'],
            //     'column_definitions' => [
            //         'policy_code' => 'Policy Code',
            ...
            'commissions' => [
                ...
                'session_key' => 'commission_columns',
                'default_columns' => [
                    'policy_code','client_name','insurer','grouping','basic_premium','rate','amount_due',
                    'payment_status','amount_received','date_rcvdate_receivedd','statement_no','mode_of_payment','variance','reason','date_due','cnid'
                ],
                'mandatory_columns' => ['policy_code', 'client_name', 'cnid'],
                'column_definitions' => [
                    'policy_code' => 'Policy Code',
